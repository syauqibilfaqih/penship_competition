...
class AccousticPreception(Node):
    thrustRight=0.0
    thrustLeft=0.0
    posRight=0.0
    posLeft=0.0
    ...
    def __init__(self):
        super().__init__('accoustic_preception')
    ...
    def accousticpreception(self):
        if abs(self.bearingDeg)>0.2:
            ...
            if self.rangeDist > 0.2:
                self.thrustLeft=3000.0
                self.thrustRight=3000.0
            else:
                self.thrustLeft=0.0
    ...
    def listener_callbackBeacon(self, msg):
        ...
        self.accousticpreception()

def main(args=None):
    rclpy.init(args=None)
    accoustic_preception = AccousticPreception()
    rclpy.spin(accoustic_preception)
